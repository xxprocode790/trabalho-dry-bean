...
st.append(Paragraph("<b>Integrantes:</b> Luciano Schumann", estilo_centro))
st.append(Paragraph("<b>Disciplina:</b> INTELIGÊNCIA ARTIFICIAL E COMPUTACIONAL", estilo_centro))
st.append(Paragraph("<b>Data:</b> 11 de junho de 2026", estilo_centro))
st.append(Paragraph("<b>Repositório GitHub:</b> https://github.com/xxprocode790/trabalho-dry-bean", estilo_centro))
...
st.append(Paragraph(
    'O repositório <u>https://github.com/xxprocode790/trabalho-dry-bean</u> contém: <b>dados/</b> (arquivo original '
